...
<meta charset="UTF-8">
<meta name="description" content="Ecoscape">
...
<body>
    ...
    <header class="header-section">
        <!-- Top Bar -->
<!-- Add styling for the admin button or icon -->
<style>
    .admin-button {
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                    ...
                                    <div class="select-button">
                                        ...
                                        <a href="shopping-cart.php?checkout=true" class="primary-btn checkout-btn">CHECK OUT</a>
                                    </div>
                                </div>
                            </li>
