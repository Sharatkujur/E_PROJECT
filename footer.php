            ...
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.php"> <span>Ecoscape</span>
                        </a>
                    </div>
                    <ul>
                        <li>+91 8849656188</li>
                        <li>ecoscape815@gmail.com</li>
                    </ul>
                    <div class="footer-social">
                           <a href="https://www.instagram.com/trendycart.official/profilecard/?igsh=Y2JzYjExa2hmeWln" target="_blank"><i class="fa fa-instagram"></i></a>
                    </div>
                </div>
            </div>
